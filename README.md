...
# サービスの概要
「次の一杯」をもっと楽しく、もっと自分好みに。

Coffee Appは、日々楽しむコーヒーの記録（ログ）を蓄積し、そこから自分の本当の好みを分析・発見するための管理ツールです。

単なる備忘録としての記録機能だけでなく、蓄積されたデータから「自分の理想の味」を数値化し、次に試すべきコーヒー豆を提案してくれる機能や、購入した場所を地図で振り返る機能を備えています。

開発の背景

「コーヒー豆を買ってみたものの、自分の好みに合わなかった」という経験や、「以前飲んだあの味が美味しかったけれど、どの店で買ったか忘れてしまった」という課題を解決したいと考え、このアプリを開発しました。
自分の感覚的な「美味しい」をデータとして残すことで、自分だけの最高のコーヒーライフをサポートします。

主な機能

コーヒーログ管理: 購入した豆や店舗の名前などの情報、焙煎度・味わい（酸味・苦味・コク・香り）を5段階で詳細に記録。

店舗マップ連携: 購入したお店を地図上にピン留め。ピンをクリックして過去の購入履歴を即座に確認。

好みの分析:過去の登録データから、あなたの好みの平均値を算出。
